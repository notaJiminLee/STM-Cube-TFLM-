/**
  ******************************************************************************
  * @file    facedetection.c
  * @author  AST Embedded Analytics Research Platform
  * @date    Mon Feb 15 17:35:42 2021
...
#define AI_NET_OBJ_INSTANCE g_facedetection
 
#undef AI_FACEDETECTION_MODEL_SIGNATURE
#define AI_FACEDETECTION_MODEL_SIGNATURE     "9d1a045a894eb398c06acc214a7cefda"
...
#define AI_TOOLS_DATE_TIME   "Mon Feb 15 17:35:42 2021"

#undef AI_TOOLS_COMPILE_TIME
#define AI_TOOLS_COMPILE_TIME    __DATE__ " " __TIME__

#undef AI_FACEDETECTION_N_BATCHES
#define AI_FACEDETECTION_N_BATCHES         (1)
...
AI_STATIC ai_array conv2d_4_scratch1_array;   /* Array #0 */
AI_STATIC ai_array conv2d_4_scratch0_array;   /* Array #1 */
AI_STATIC ai_array conv2d_2_scratch1_array;   /* Array #2 */
AI_STATIC ai_array conv2d_2_scratch0_array;   /* Array #3 */
...
AI_STATIC ai_array conv2d_0_bias_array;   /* Array #12 */
AI_STATIC ai_array conv2d_0_weights_array;   /* Array #13 */
AI_STATIC ai_array input_output_array;   /* Array #14 */
AI_STATIC ai_array conv2d_0_output_array;   /* Array #15 */
...
AI_STATIC ai_array dense_6_fmt_output_array;   /* Array #19 */
AI_STATIC ai_array nl_7_output_array;   /* Array #20 */
AI_STATIC ai_array nl_7_fmt_output_array;   /* Array #21 */


/**  Forward network tensor declarations  *************************************/
AI_STATIC ai_tensor conv2d_4_scratch1;   /* Tensor #0 */
AI_STATIC ai_tensor conv2d_4_scratch0;   /* Tensor #1 */
AI_STATIC ai_tensor conv2d_2_scratch1;   /* Tensor #2 */
AI_STATIC ai_tensor conv2d_2_scratch0;   /* Tensor #3 */
...
AI_STATIC ai_tensor conv2d_0_bias;   /* Tensor #12 */
AI_STATIC ai_tensor conv2d_0_weights;   /* Tensor #13 */
AI_STATIC ai_tensor input_output;   /* Tensor #14 */
AI_STATIC ai_tensor conv2d_0_output;   /* Tensor #15 */
AI_STATIC ai_tensor conv2d_2_output;   /* Tensor #16 */
AI_STATIC ai_tensor conv2d_4_output;   /* Tensor #17 */
AI_STATIC ai_tensor conv2d_4_output0;   /* Tensor #18 */
AI_STATIC ai_tensor dense_6_output;   /* Tensor #19 */
AI_STATIC ai_tensor dense_6_fmt_output;   /* Tensor #20 */
AI_STATIC ai_tensor nl_7_output;   /* Tensor #21 */
AI_STATIC ai_tensor nl_7_fmt_output;   /* Tensor #22 */
...
AI_STATIC_CONST ai_tensor_chain dense_6_fmt_chain;   /* Chain #4 */
AI_STATIC_CONST ai_tensor_chain nl_7_chain;   /* Chain #5 */
AI_STATIC_CONST ai_tensor_chain nl_7_fmt_chain;   /* Chain #6 */
...
AI_STATIC ai_layer_nl dense_6_fmt_layer; /* Layer #4 */
AI_STATIC ai_layer_nl nl_7_layer; /* Layer #5 */
AI_STATIC ai_layer_nl nl_7_fmt_layer; /* Layer #6 */


/**  Array declarations section  **********************************************/
/* Array#0 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_4_scratch1_array, AI_ARRAY_FORMAT_U8,
  NULL, NULL, 512, AI_STATIC)

/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_4_scratch0_array, AI_ARRAY_FORMAT_S8,
  NULL, NULL, 8576, AI_STATIC)

/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_2_scratch1_array, AI_ARRAY_FORMAT_U8,
...
/* Array#4 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_0_scratch1_array, AI_ARRAY_FORMAT_U8,
  NULL, NULL, 2048, AI_STATIC)

/* Array#5 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_0_scratch0_array, AI_ARRAY_FORMAT_S8,
  NULL, NULL, 5228, AI_STATIC)
...
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  dense_6_weights_array, AI_ARRAY_FORMAT_U8,
...
/* Array#18 */
AI_ARRAY_OBJ_DECLARE(
  dense_6_output_array, AI_ARRAY_FORMAT_U8,
  NULL, NULL, 10, AI_STATIC)
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_4_scratch1_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.10269249230623245f),
    AI_PACK_UINTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_scratch1_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.08305741101503372f),
    AI_PACK_UINTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_scratch1_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.09335681796073914f),
    AI_PACK_UINTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(dense_6_bias_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.00025980634381994605f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(dense_6_weights_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.002529944758862257f),
    AI_PACK_UINTQ_ZP(101)))

/* Int quant #5 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_4_bias_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0003218516940250993f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_4_weights_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003875050926581025f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_bias_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0005896741058677435f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_weights_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.006316347513347864f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_bias_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(9.163664071820676e-05f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_weights_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.01163785345852375f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(dense_6_output_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_U8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.14112964272499084f),
    AI_PACK_UINTQ_ZP(95)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 8576, 1, 1), AI_STRIDE_INIT(4, 1, 1, 8576, 8576),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 16, 2), AI_STRIDE_INIT(4, 1, 1, 32, 512),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1, 5228, 1, 1), AI_STRIDE_INIT(4, 1, 1, 5228, 5228),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 1024, 10, 1, 1), AI_STRIDE_INIT(4, 1, 1024, 10240, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 32, 5, 5, 64), AI_STRIDE_INIT(4, 1, 32, 160, 800),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 32, 5, 5, 32), AI_STRIDE_INIT(4, 1, 32, 160, 800),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0,
  AI_SHAPE_INIT(4, 3, 5, 5, 32), AI_STRIDE_INIT(4, 1, 3, 15, 75),
...
AI_LAYER_OBJ_DECLARE(
  ...
  .pool_func = pool_func_mp_array_integer_UINT8, 
)
...
AI_LAYER_OBJ_DECLARE(
  dense_6_layer, 6,
  DENSE_TYPE,
  dense, forward_dense_integer_UAUA,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 18528, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FACEDETECTION_IN_NUM, &input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_FACEDETECTION_OUT_NUM, &nl_7_fmt_output),
...
AI_API_ENTRY
ai_bool ai_facedetection_get_info(
  ai_handle network, ai_network_report* report)
{
  ...
  {
    ai_network_report r = {
      .model_name        = AI_FACEDETECTION_MODEL_NAME,
      .model_signature   = AI_FACEDETECTION_MODEL_SIGNATURE,
...
AI_API_ENTRY
ai_error ai_facedetection_get_error(ai_handle network)
{
...
AI_API_ENTRY
ai_handle ai_facedetection_destroy(ai_handle network)
{
...
AI_API_ENTRY
ai_i32 ai_facedetection_forward(ai_handle network, const ai_buffer* input)
{
