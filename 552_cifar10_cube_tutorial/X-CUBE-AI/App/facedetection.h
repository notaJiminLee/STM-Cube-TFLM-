...
#ifndef __AI_FACEDETECTION_H__
#define __AI_FACEDETECTION_H__
#pragma once

#include "ai_platform.h"
#include "ai_platform_interface.h"

#define AI_FACEDETECTION_MODEL_NAME          "facedetection"

#define AI_FACEDETECTION_ACTIVATIONS_ALIGNMENT   (4)

#define AI_FACEDETECTION_IN_NUM       (1)
#define AI_FACEDETECTION_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 32, 32, 3, 1, NULL), \
}
#define AI_FACEDETECTION_IN_SIZE { \
  (32 * 32 * 3), \
}
#define AI_FACEDETECTION_IN_1_SIZE  (32 * 32 * 3)
#define AI_FACEDETECTION_IN_1_SIZE_BYTES  ((32 * 32 * 3) * 1)





#define AI_FACEDETECTION_OUT_NUM      (1)
#define AI_FACEDETECTION_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 10, 1, NULL), \
}
#define AI_FACEDETECTION_OUT_SIZE { \
  (1 * 1 * 10), \
}
#define AI_FACEDETECTION_OUT_1_SIZE  (1 * 1 * 10)
#define AI_FACEDETECTION_OUT_1_SIZE_BYTES  ((1 * 1 * 10) * 1)

#define AI_FACEDETECTION_N_NODES (7)
 ...
 * @ref ai_facedetection_create. Both the activations memory buffer 
 ...
 * using @ref ai_facedetection_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_FACEDETECTION_*
 * defines into file @ref facedetection.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_facedetection_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /*__AI_FACEDETECTION_H__*/
